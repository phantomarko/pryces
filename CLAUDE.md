...
- `notification_result.py` — `NotificationResult` frozen dataclass (messages: `list[str]`, fulfilled_targets: `list[Decimal]` — returned by `Stock.generate_notifications()`)
