...
- `dtos.py` — `StockDTO` (maps domain Stock to DTO, includes market_state, kind, and cap_size: str | None), `TargetPriceDTO` (symbol + target Decimal)
